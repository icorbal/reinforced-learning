...
class HumanoidStandupEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def step(self, a):
        ...
        #print(s(z_angle) + ", " + s(pelvis_height))
        #print("head = " + str(head_height) + ", pelvis = " + str(pelvis_height) + ", step = " + str(self.num_steps) + ", reward = " + str(reward))
        done = bool(self.num_steps > 1000)
        return (
            self._get_obs(),
            reward,
            done,
